...
Sometimes you'll also need to set your <tt>DYLD_FALLBACK_LIBRARY_PATH</tt>
environment variable to the directory of the <tt>libmagic.1.dylib</tt>:
...
need to set your +PATH+ environment variable to the directory of the
+magic1.dll+ file:

  set PATH=C:\Program Files\GnuWin32\bin;%PATH%

It might be also required to add +:database+ option explicitely:
